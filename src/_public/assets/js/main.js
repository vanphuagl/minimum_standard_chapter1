...
let qas = [
  ...
  },
  {
    ...
    desc: "紹介している量はあくまでも目安になります。ただし、これ以上の量を加えると刺激が強過ぎる可能性があるので注意してください。",
  },
  {
    id: 4,
    title: "使用期限はどのくらいですか？",
    desc: "パッケージ裏面に賞味期限を記載しています。遮光して、涼しい所に保管してください。",
  },
  {
    id: 5,
    title: "ハッカ油は何からできたものですか？",
    desc: "ハッカ油とはハッカソウというミントを乾燥させて抽出した植物油のことです。",
  },
];
